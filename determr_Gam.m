%%%%%下面是determr_Gam函数的定义。
%%%%%%3B. 以下反求三维空间中的裂隙总数，并确定三维空间中的r服从何种分布，这是r2服从Gamma分布的情况
function [Normexpt, Normvarp, Normchi2, Gamexpt, Gamvarp, Gamchi2, Lognexpt, Lognvarp, Lognchi2]=determr_Gam(aa,zz,theta,nm2,Gamnv2)
uty=unifrnd(0,1,1,100000);	%生成一组u/r的随机数
chtor2=1-uty.^2; 		%相应于u/r，生成一组ch2/r2的随机数
nm=nm2^2/Gamnv2;	%gamma分布用此二式计算nm,nv
nv=Gamnv2/nm2;
r2=gamrnd(nm,nv,1,100000);
